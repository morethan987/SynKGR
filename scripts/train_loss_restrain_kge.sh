...
case "$DATASET" in
    CoDEx-S)
        ...
        AUX_CONFIDENCE="MCTS/output/codex-s-kge/20260424_223000/auxiliary_triples_confidence.json"
        ;;
    FB15k-237N)
        NAME='fb15k_train'
        ...
        AUX_CONFIDENCE="MCTS/output/fb15k-237n-kge/20260425_215000/auxiliary_triples_confidence.json"
        ;;
esac
